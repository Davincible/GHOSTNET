	...
	onMount(() => {
      ...
      `,
		...
		voxelData.forEach((voxel, i) => {
			const pos = new THREE.Vector3(voxel.x * voxelSize, voxel.y * voxelSize, voxel.z * voxelSize);
      ...
      `,
		...
		voxelData.forEach((voxel, i) => {
			matrix.setPosition(voxel.x * voxelSize, voxel.y * voxelSize, voxel.z * voxelSize);
...
<div bind:this={container} class="rabbit-voxel" style="width: {width}px; height: {height}px;"></div>
