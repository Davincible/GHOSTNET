...
| 15 | [Remote Functions](./15-RemoteFunctions.md) | `query()`, `action()`, `form()` — *Experimental* |
| 16 | [SSR & Hydration](./16-SSRAndHydration.md) | SSR safety, hydration mismatches, `browser` |
| 17 | [Async SSR](./17-AsyncSSR.md) | Top-level `await` in components — *Experimental* |
...
*Based on official Svelte documentation and production experience.*
