...
//! processor.start().await?; // Runs until error or shutdown
//! ```
...
impl RealtimeProcessor {
        ...
        P: Provider,
    {
        ...
        // For MegaETH realtime logs, the block may be a mini-block
        // Try to get the block, but fall back to current time if unavailable
