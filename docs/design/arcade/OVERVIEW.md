...
│  │ (future block│   │ (depends:    │   │ (depends:    │                     │
│  │  hash)       │   │  matchmaking)│   │  engine only)│                     │
│  └──────────────┘   └──────────────┘   └──────────────┘                     │
│                                                                              │
...
│  │ (block hash) │   │ (commit-     │   │ (future block│                     │
│  │              │   │  reveal)     │   │  hash)       │                     │
│  └──────────────┘   └──────────────┘   └──────────────┘                     │
│                                                                              │
...
- ✅ `docs/learnings/006-amount-scale-truncation-precision.md`
...
- ✅ `infrastructure/randomness.md` - Future block hash + commit-reveal patterns
...
│   └── randomness.md                  # ✅ Future block hash/fairness spec
└── designs/
